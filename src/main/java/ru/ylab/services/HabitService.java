...
/**
 * Class implementing CRUD logic for working with habits.
 *
 * @author azatyamanaev
 */
public class HabitService {
    ...
    /**
     * Creates new HabitService.
     *
     * @param habitRepository        HabitRepository instance
     * @param habitHistoryRepository HabitHistoryRepository instance
     */
    public HabitService(HabitRepository habitRepository, HabitHistoryRepository habitHistoryRepository) {
