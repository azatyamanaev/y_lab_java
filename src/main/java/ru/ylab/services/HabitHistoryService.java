...
public class HabitHistoryService {
    ...
    /**
     * Creates new HabitHistoryService
     *
     * @param habitRepository        HabitRepository instance
     * @param habitHistoryRepository HabitHistoryRepository instance
     */
    public HabitHistoryService(HabitRepository habitRepository, HabitHistoryRepository habitHistoryRepository) {
     ...
     * @return streak
     */
    public int countStreak(@NotNull Habit habit) {
        HabitHistory history = habitHistoryRepository.getByHabitId(habit.getId());
        if (history == null) {
            return 0;
        }
     ...
     */
    public String completionPercent(@NotNull Habit habit, LocalDate from, LocalDate to) {
        HabitHistory history = habitHistoryRepository.getByHabitId(habit.getId());
        if (history == null) {
            return "0%";
        }
